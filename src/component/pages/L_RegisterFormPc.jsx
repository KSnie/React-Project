...
const RegisterFormPc = ({ onAuthentication, isPcRequest }) => {
  ...
  const handleSubmit = (e) => {
    ...
    try {
      onAuthentication("registerPc", NaN,NaN,NaN,isfullname, isdateofbirth, isphonenumber, iscountry,"https://");
    } catch (error) {
        ...
        <div className="RegisterFormPc-content-container">
          ...
          <div className="RegisterFormPc-main-content">
            <div className="RegisterFormPc-left-content">
                ...
                <div className="RegisterFormPc-require-text">
                  <h5>Required Documents</h5>
                  <ul className="RegisterFormPc-ul-text">
                    <li>ID Card</li>
            ...
            <div className="RegisterFormPc-Right-content">
              ...
              <div className="RegisterFormPc-file-select">
                <h5>Upload files</h5>

                <img className="RegisterFormPc-profile-add" src={addfile} alt="addfiles" />
                <h6>Click to upload</h6>
                <img className="RegisterFormPc-imagefillter" src={imagefillteIcon} alt="imagefillter"/>
              </div>
            </div>
          ...
          <div className="RegisterFormPc-bottom">
            <button onClick={() => { handleSubmit(); isPcRequest(); }}>Register as a Project Creator</button>
          </div>
